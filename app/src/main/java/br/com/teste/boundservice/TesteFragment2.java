 ...
 */
public class TesteFragment2 extends Fragment {
    private static final String PREF_NAME = "MainActivityPreferences";

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View freg_teste = inflater.inflate(R.layout.fragmet_teste_dois,container,false);

        SharedPreferences sp1 = getActivity().getSharedPreferences(PREF_NAME,0);
        SharedPreferences.Editor  editor = sp1.edit();
        editor.putString("string_teste","teste2");
        editor.commit();
